...
def render_path(render_poses, hwf, K, chunk, render_kwargs, gt_imgs=None, savedir=None, render_factor=0, test_vids=None):
...
# TODO: add print psnr
        if savedir is not None:
            ...
            if test_vids is not None:
                filename = os.path.join(savedir, '2_test_{:04d}.png'.format(test_vids[i]))
            else:
